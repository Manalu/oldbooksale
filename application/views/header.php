...
<div class="container">
 ...
 <?php if ( $this->session->userdata('role')>0){?>
  ...
  <button class="navbar-tbar-expand-lg  bg-primary navbar-dark  fixed-topoggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
